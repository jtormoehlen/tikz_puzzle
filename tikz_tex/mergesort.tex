...
16
\end{minipage}
};\node[draw, rounded corners, fill=lightgray!20, minimum width=0.5*\rectWidth, minimum height=\rectHeight, anchor=north west] (rect18) at (rect17.south west) {
\begin{minipage}[c]{6.5cm}
\begin{lstlisting}[language=Python, breaklines=true]
left = mergesort(left) 
\end{lstlisting}
...
17b
\end{minipage}
};\node[draw, rounded corners, fill=lightgray!20, minimum width=0.5*\rectWidth, minimum height=\rectHeight, anchor=west] (rect1801) at (rect18.east) {
\begin{minipage}[c]{6.5cm}
\begin{lstlisting}[language=Python, breaklines=true]
 mergesort(left)
\end{lstlisting}
